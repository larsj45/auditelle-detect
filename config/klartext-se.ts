...
const config: ResellerConfig = {
  ...
  strings: {
    ...
    dashboard: {
      ...
      upgradeCreditsTitle: 'Köp analyser',
      upgradeCreditsSubtitle: 'Köp enstaka krediter för att testa Klartext eller hantera en tillfällig granskning utan månadsbindning.',
      upgradeCurrentBalance: 'Aktuellt saldo: {count}',
      upgradeCreditSingular: 'analys',
      upgradeCreditPlural: 'analyser',
      upgradeCreditPackTrialLabel: '1 analys',
      upgradeCreditPackTrialDescription: 'Enstaka test',
      upgradeCreditPackStandardLabel: '10 analyser',
      upgradeCreditPackStandardDescription: 'Paket för en mindre grupp',
      upgradeCreditPackBestLabel: '50 analyser',
      upgradeCreditPackBestDescription: 'Bäst värde',
      upgradePerAnalysis: '{price} per analys',
      upgradeBuy: 'Köp',
      upgradeRedirecting: 'Omdirigerar...',
      upgradeSubscriptionsTitle: 'Abonnemang för skolor och team',
      upgradeSubscriptionsSubtitle: 'För återkommande användning ger månadsplaner större volym, rapporter och lägre kostnad per analys.',
      upgradeTrustStripe: 'Säker betalning via Stripe',
      upgradeTrustCredits: 'Krediter upphör aldrig att gälla',
      upgradeTrustReports: 'Exporterbara PDF-rapporter',
      upgradeCheckoutCreditsDescription: '{count} krediter för AI- och plagiatdetektion med exporterbar rapport',
    },
