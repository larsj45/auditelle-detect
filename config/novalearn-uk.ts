...
const config: ResellerConfig = {
  ...
  strings: {
    ...
    dashboard: {
      ...
      upgradeCreditsTitle: 'Buy analyses',
      upgradeCreditsSubtitle: 'Buy one-off credits to test NovaLearn or handle a short marking run without a monthly commitment.',
      upgradeCurrentBalance: 'Current balance: {count}',
      upgradeCreditSingular: 'analysis',
      upgradeCreditPlural: 'analyses',
      upgradeCreditPackTrialLabel: '1 analysis',
      upgradeCreditPackTrialDescription: 'One-off test',
      upgradeCreditPackStandardLabel: '10 analyses',
      upgradeCreditPackStandardDescription: 'Pack for a small class',
      upgradeCreditPackBestLabel: '50 analyses',
      upgradeCreditPackBestDescription: 'Best value',
      upgradePerAnalysis: '{price} per analysis',
      upgradeBuy: 'Buy',
      upgradeRedirecting: 'Redirecting...',
      upgradeSubscriptionsTitle: 'Subscriptions for schools and teams',
      upgradeSubscriptionsSubtitle: 'For recurring use, monthly plans provide higher volume, reports and a lower cost per analysis.',
      upgradeTrustStripe: 'Secure payment by Stripe',
      upgradeTrustCredits: 'Credits never expire',
      upgradeTrustReports: 'Exportable PDF reports',
      upgradeCheckoutCreditsDescription: '{count} credits for AI and plagiarism detection with an exportable report',
    },
    ...
    // Public tester page
    tester: {
      badge: 'Free test — No account required',
      title: 'Test the Turnitin alternative',
      subtitle: 'Paste a text and check AI, plagiarism or both in seconds.',
      testsRemaining: '{count} free tests remaining',
      limitReached: 'Limit reached — create an account to continue',
      minCharsError: 'Please enter at least 50 characters for a reliable analysis.',
      analysisError: 'Error during analysis',
      internalError: 'Something went wrong',
      textareaPlaceholder: 'Paste the text to analyse here (minimum 50 characters, maximum 5000)...',
      characterCount: '{count} / 5000 characters',
      analyzeFree: 'Analyse for free',
      loading: 'Analysing...',
      ctaTitle: 'Like NovaLearn?',
      ctaTitleLimit: 'Continue with a free account',
      ctaBody: 'Create a free account to analyse texts with full history, exportable reports and academic integrity support.',
      ctaButton: 'Create free account',
      featureAccuracyTitle: '99.9% accuracy',
      featureAccuracyBody: 'Technology validated by the University of Maryland',
      featureSectionTitle: 'Section analysis',
      featureSectionBody: 'Pinpoints exactly which parts were generated by AI',
      featureModelTitle: 'Model detection',
      featureModelBody: 'ChatGPT, Claude, Gemini, Llama... we identify them all',
    },
    ...
    plagiarism: {
      ...
      highlightedPassages: 'Detected passages in your text',
