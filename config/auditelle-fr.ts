...
const config: ResellerConfig = {
  ...
  strings: {
    ...
    dashboard: {
      ...
      upgradeCreditPackTrialLabel: '1 analyse',
      upgradeCreditPackTrialDescription: 'Essai ponctuel',
      upgradeCreditPackStandardLabel: '10 analyses',
      upgradeCreditPackStandardDescription: 'Pack standard pour une petite série',
      upgradeCreditPackBestLabel: '50 analyses',
      upgradeCreditPackBestDescription: 'Meilleur rapport qualité-prix',
      upgradePerAnalysis: '{price} par analyse',
      upgradeBuy: 'Acheter',
      upgradeRedirecting: 'Redirection...',
      upgradeSubscriptionsTitle: 'Abonnements pour professionnels',
      upgradeSubscriptionsSubtitle: 'Pour un usage régulier, les abonnements offrent plus de volume et un meilleur coût par analyse.',
      upgradeTrustStripe: 'Paiement sécurisé par Stripe',
      upgradeTrustCredits: 'Les crédits n’expirent jamais',
      upgradeTrustReports: 'Rapports PDF exportables',
      upgradeCheckoutCreditsDescription: '{count} crédits pour détecter l’IA et le plagiat avec rapport exportable',
    },
    ...
    plagiarism: {
      ...
      sourcesFound: '{count} source(s) trouvée(s)',
      sourceLabel: 'Source',
    ...
    planDetails: {
      pro: {
        name: 'Professionnel',
        features: ['1 000 analyses/mois', 'Export PDF/CSV', 'Support email', 'Historique 30 jours'],
      },
      university: {
        name: 'Université',
