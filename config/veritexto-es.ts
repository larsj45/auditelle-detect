...
const config: ResellerConfig = {
  ...
  strings: {
    ...
    dashboard: {
      ...
      upgradeCreditsTitle: 'Comprar análisis',
      upgradeCreditsSubtitle: 'Compra créditos sueltos para probar VeriTexto o cubrir una necesidad puntual sin compromiso mensual.',
      upgradeCurrentBalance: 'Saldo actual: {count}',
      upgradeCreditSingular: 'análisis',
      upgradeCreditPlural: 'análisis',
      upgradeCreditPackTrialLabel: '1 análisis',
      upgradeCreditPackTrialDescription: 'Prueba puntual',
      upgradeCreditPackStandardLabel: '10 análisis',
      upgradeCreditPackStandardDescription: 'Pack para un grupo pequeño',
      upgradeCreditPackBestLabel: '50 análisis',
      upgradeCreditPackBestDescription: 'Mejor relación calidad-precio',
      upgradePerAnalysis: '{price} por análisis',
      upgradeBuy: 'Comprar',
    ...
    emails: {
      ...
      limitReached: {
        ...
        greeting: 'Hola {name},',
        body: 'Has utilizado todos tus análisis gratuitos en VeriTexto este mes. Tu límite se restablece el próximo mes, pero si necesitas analizar más textos ahora, tenemos algo para ti.',
