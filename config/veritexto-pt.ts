...
const config: ResellerConfig = {
  ...
  strings: {
    ...
    dashboard: {
      ...
      upgradeCreditsTitle: 'Comprar análises',
      upgradeCreditsSubtitle: 'Compre créditos avulsos para testar o VeriTexto ou corrigir uma demanda pontual sem compromisso mensal.',
      upgradeCurrentBalance: 'Saldo atual: {count}',
      upgradeCreditSingular: 'análise',
      upgradeCreditPlural: 'análises',
      upgradeCreditPackTrialLabel: '1 análise',
      upgradeCreditPackTrialDescription: 'Teste pontual',
      upgradeCreditPackStandardLabel: '10 análises',
      upgradeCreditPackStandardDescription: 'Pacote para uma turma pequena',
      upgradeCreditPackBestLabel: '50 análises',
      upgradeCreditPackBestDescription: 'Melhor custo-benefício',
      upgradePerAnalysis: '{price} por análise',
      upgradeBuy: 'Comprar',
